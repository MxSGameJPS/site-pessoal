    ...
    <StyledWrapper>
      <div className="card">
        ...
        <div className="popup">
          ...
          <p>Conheça mais sobre minha trajetória</p>
...
const StyledWrapper = styled.div`
  ...
  .card {
    width: 164px;
    height: 276px;
    background: url("/fundosobremim.png");
  ...
  .popup {
    background-color: rgba(121, 54, 54, 0.85);
  ...
  .card:hover {
    ...
    box-shadow: 0px 0px 15px 5px rgba(179, 69, 69, 0.7);
    z-index: 5;
  }
