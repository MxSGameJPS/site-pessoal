...
const StyledWrapper = styled.div`
  ...
  .card {
    min-width: 350px; /* Reduz o tamanho mínimo */
    padding: 0.8rem; /* Ajusta padding */
    border-radius: 10px; /* Mantém arredondamento */
  }

  .wrap {
    gap: 0.8rem; /* Reduz o gap */
  }

  .head {
    min-height: 35px; /* Reduz altura mínima */
    padding-inline: 10px; /* Ajusta padding interno */
  }

  .title {
    font-size: 18px; /* Reduz tamanho do texto */
    gap: 6px; /* Ajusta espaço entre ícone e texto */
  }
  ...
  .body {
    padding: 0.8rem;
    font-size: 14px; /* Reduz tamanho do código */
    line-height: 17px; /* Ajusta linha */
  }

  .pre {
    font-size: 14px; /* Ajusta tamanho do pre */
  }

  .cmd::before {
    animation: inputs 6s steps(22) infinite; /* Reduz duração da animação */
  }
}
